...
public class Enemy extends Actor
{
   ...
   /** 
    * Takes the points from the instance variable points of the enemy and assigns them 
    * one at a time to a radom stat (health, damage, or speed).
    */
    ...
    public void assignImage()
    {
        ...
        if(rand == 1)
        {
            img = new GreenfootImage("enemy1.jpg");
        }
        else if(rand == 2)
        {
            img = new GreenfootImage("enemy2.jpg");
        }
        else if(rand == 3)
        {
            img = new GreenfootImage("enemy3.jpg");
        }
        else if(rand == 4)
        {
            img = new GreenfootImage("enemy4.jpg");
        }
    }
